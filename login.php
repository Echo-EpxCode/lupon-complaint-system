...
<body
    style="background: linear-gradient(135deg, #1e3c00 0%, #2d5a27 25%, #3d7a3d 50%, #2d5a27 75%, #1e3c00 100%); min-height: 100vh;">
    <!-- Center Form on Page -->
    <!-- Center Form on Page -->
    <div class="d-flex justify-content-center align-items-center min-vh-100 py-4">
        <div class="card shadow-lg p-4"
            style="max-width: 400px; width: 100%; background: rgba(255, 255, 255, 0.95); border-radius: 15px;">
