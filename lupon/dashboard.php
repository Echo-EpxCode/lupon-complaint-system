<?php
    ...
    // Fetch complaint counts for each status assigned to this agent
    $counts = [
        'pending' => 0,
        'in_progress' => 0,
        'resolved' => 0,
    ...
    $countSql = "SELECT status_id, COUNT(*) as count FROM complaints WHERE assigned_agent_id = ? GROUP BY status_id";
    $countStmt = mysqli_prepare($conn, $countSql);
    mysqli_stmt_bind_param($countStmt, "i", $agent_id);
    ...
    // Total complaints assigned to this agent
